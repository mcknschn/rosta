# Rösta — leveranslogg (arkiverad historik)

> **❄️ FRYST ARKIV (utbruten ur BACKLOG.md 2026-06-14).** Det här är den daterade leverans-
> historiken för Rösta — vad som byggts och verifierats 2026-06-03 … 2026-06-12, plus den gamla
> "Status per spår"-ögonblicksbilden. Den uppdateras inte längre. Aktuellt arbete och öppna poster
> finns i den levande [../BACKLOG.md](../BACKLOG.md); fas-historik i [ROADMAP.md](ROADMAP.md).
> Siffertal i posterna är ögonblicksvärden vid respektive datum (t.ex. tidiga "version 0"/"192
> ståndpunkter") — aktuellt läge: version 2 / 269 ståndpunkter / 46 evidensposter.
...
- ✅ **B2 (nionde leveransen) — demokrati: lagstadgat oberoende public service (enhällighet, codex-granskat)** ([evidence_ledger](../../config/evidence_ledger.yaml)
  + [party_positions](../../config/party_positions.yaml) + [evidens_trovardighet.md](evidens_trovardighet.md)): undermåttet **yttrandefrihet_medier** (tidigare B-tomt)
...
- ✅ **Spår D-expansionen** (tracker: [spar_D_datatackning.md](spar_D_datatackning.md), svep/natt-
  rapporter arkiverade i [done/](.)): 24/56 → **43/68 inlästa indikatorer, 29/35 undermått,
...
- ✅ **D-täckningskrympning (2026-06-12)** ([done/d_coverage_krympning_spec.md](d_coverage_krympning_spec.md)):
