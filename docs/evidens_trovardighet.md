...
| demokrati | **3/5** | 4–5² | god — 1 differentierande (JuU28) + 2 neutrala |
| forsvar | **3/5** | 3³ | nato byggt; leverans HOLD (steg 1+2 ej samtidigt), ambition = target |
| integration | 2/5 | 3–4⁴ | HOLD ×2 (normer_tillit + boendesegregation, se §6) |
| valfard | 2/4 | 3⁵ | HOLD ×2 (vård + omsorg, se §6) |
...
**Sammanlagt:** 36 evidensposter / 192 ståndpunkter (2026-06-06: +2 poster, +16 ståndpunkter via de två
enhällighet-måtten). Allt aktuellt arbete ocommittat tills sign-off; `dist/`-snapshot medvetet ej
...
### Ekonomi — 4/6 ✅ · Demokrati — 3/5
- Färdigställda 2026-06-05; se [BACKLOG.md](BACKLOG.md). Demokrati kvar otäckt: transparens_ansvar
  (dubbelräkning) + yttrandefrihet_medier (acklamation/regeringslägesartefakt).
