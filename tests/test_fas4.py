...
def test_shipped_party_positions_are_sourced_not_fabricated() -> None:
    ...
    assert pp.get("version") == 0  # ännu ej produktionsklar
    assert pp.get("status") in {
        "seed_requires_curation", "pilot_klimat_unreviewed", "draft_alla_kategorier_unreviewed",
        "harmonized_alla_kategorier_unreviewed",
    }
