    ...
    out = {
        "meta": {
            ...
            "coverage": (f"Preliminär: A=agerande (a2 motionsprioritering, andel av egna "
                         ...
                         "årsserier för ekonomi/välfärd/trygghet/klimat/integration där partiet "
                         "haft nationell makt (medel säkerhet, ej tillämplig för partier utan makt "
                         "och för försvar/demokrati som saknar D-data). B är AKTIVERAD "
