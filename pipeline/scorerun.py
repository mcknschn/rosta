    ...
    out = {
        "meta": {
            ...
            "coverage": (f"Preliminär: A=agerande (a2 motionsprioritering, andel av egna "
                         ...
                         "årsserier för ekonomi/välfärd/trygghet/klimat/integration/försvar där "
                         "partiet haft nationell makt (medel säkerhet, ej tillämplig för partier "
                         "utan makt och för demokrati som ännu saknar D-data). B är AKTIVERAD "
